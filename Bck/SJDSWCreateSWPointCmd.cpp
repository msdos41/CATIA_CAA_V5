...
//===================================================================
//
// SJDSWCreateSWPointCmd.cpp
// The state chart based command: SJDSWCreateSWPointCmd
//
//===================================================================
//
// Usage notes:	 在选择多个连接件（2~4）之后，在某个连接件中选择曲面，
//				 创建临时点，临时点跟随鼠标在该曲面上移动，鼠标左键后
//				 确定临时点位置，执行Create，创建相应焊点。
//
//===================================================================
//
//  May 2015  Creation: Code generated by the CAA wizard  ibm
//===================================================================
#include "SJDSWCreateSWPointCmd.h"
...
CATCreateClass( SJDSWCreateSWPointCmd);


//-------------------------------------------------------------------------
// Constructor
//-------------------------------------------------------------------------
SJDSWCreateSWPointCmd::SJDSWCreateSWPointCmd() :
	CATStateCommand ("SJDSWCreateSWPointCmd", CATDlgEngOneShot, CATCommandModeExclusive) 
	...
	,_spWeldPart(NULL_var)
{
	...
	//_pSJDSpotWeldCheck = new SJDSWCheckMethod(_pSJDGeneralClass);

	HRESULT rc=E_FAIL;

	_pSJDSWPublicMethod = new SJDSWPublicMethod();
	_pSJDGeneralClass = new SJDGeneralClass();
	_pSJDSpotWeldCheck = new SJDSWCheckMethod(_pSJDGeneralClass,_pSJDSWPublicMethod);

	const char * cValue = "SJDSWXMLPath";
	char * oPath = NULL;
	CATLibStatus sStatus = CATGetEnvValue(cValue,&oPath);
	if ((sStatus ==CATLibError)||(oPath==NULL))
	{
		cout << "GetXMLEnvError"<<endl;
		_pSJDSWPublicMethod->MessegeOutput("XML not exist，pls contact administrator","Error");
		this->RequestDelayedDestruction();
		return;
	}

	rc = _pSJDSWPublicMethod->OpenXML(oPath);
	if (FAILED(rc))
	{
		_pSJDSWPublicMethod->MessegeOutput("XML error，pls contact administrator","Error");
		this->RequestDelayedDestruction();
		return;
	}
	...
	rc = _pSJDSWPublicMethod->GetTypeOriginNameFormXML(sTypeNameList);
	rc = _pSJDSWPublicMethod->GetTypeLevelFormXML(sTypeLevelList);
	//rc = _pSJDSWPublicMethod->GetIdentifierFormXML(sIdentifierList);
	...
	if(_isContinue)
	{
		...
		_pDlg = new SJDSWCreateSWPointDlg();
		_pDlg->Build();
...
// BuildGraph()
//-------------------------------------------------------------------------
void SJDSWCreateSWPointCmd::BuildGraph()
{
	//选择Part
	...
	CATAcquisitionFilter *pFilterPart = 
		Filter((FilterMethod) &SJDSWCreateSWPointCmd::CheckSelectedPart,(void *)NULL);
	...
	CATAcquisitionFilter * pFilterSurface = 
		Filter((FilterMethod) &SJDSWCreateSWPointCmd::CheckSelectedSurface,(void *)NULL);
	...
	CATAcquisitionFilter * pFilterOther = 
		Filter((FilterMethod) &SJDSWCreateSWPointCmd::CheckSelectedOther,(void *)NULL);
	...
	AddTransition( pPrtState, pPrtState, IsOutputSetCondition (_pPartAgent),
		Action ((ActionMethod) &SJDSWCreateSWPointCmd::SelectPart));
	...
	AddTransition( pPrtState, pPrtState, IsOutputSetCondition (_pSLConnectionsAgent),
		Action ((ActionMethod) &SJDSWCreateSWPointCmd::ConnectionsFieldSelected));
	...
	AddTransition(pSurfaceState,pSurfaceState,	IsOutputSetCondition(_pSurfaceAgent),
		Action((ActionMethod) &SJDSWCreateSWPointCmd::SelectSurface));
	...
	AddTransition(pSurfaceState,pSurfaceState,	IsOutputSetCondition(_pSLBaseSurfaceAgent),
		Action((ActionMethod) &SJDSWCreateSWPointCmd::BaseSurfaceFieldSelected));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pCheckDisAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::CheckButtonModify));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pSLAllCnctsAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::AllCnctsSelected));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pToLeft),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionToLeft));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pToRight),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionToRight));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pMiddlePBAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionMiddlePB));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pDeleteNewPBAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionDeleteNewPB));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pNextPBAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionNextPB));
	...
	AddTransition(pPrtState,NULL, IsOutputSetCondition(_pDiaCancelAgent), 
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionCancel));
	...
	AddTransition(pPrtState,NULL, IsOutputSetCondition(_pDiaOKAgent),
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionOK));
	...
	AddTransition(pPrtState,pPrtState, IsOutputSetCondition(_pDiaPREVIEWAgent),	
		Action((ActionMethod) &SJDSWCreateSWPointCmd::ActionPreview));
...
void SJDSWCreateSWPointCmd::UpdateHSO(CATISpecObject_var spSpecObj)
{
	_pHSO->Empty();
	HRESULT rc;
...
void SJDSWCreateSWPointCmd::UpdateHSO(CATLISTV(CATISpecObject_var) piSpecOnGeomElemList)
{
	_pHSO->Empty();
	HRESULT rc;
...
// ActionOK ()
//-------------------------------------------------------------------------
CATBoolean SJDSWCreateSWPointCmd::ActionOK( void *data )
{
	_pISO->Empty();
...
// ActionCancel ()
//-------------------------------------------------------------------------
CATBoolean SJDSWCreateSWPointCmd::ActionCancel( void *data )
{
...
// ActionPreview ()
//-------------------------------------------------------------------------
CATBoolean SJDSWCreateSWPointCmd::ActionPreview( void *data )
{
	// TODO: Define the action associated with the transition 
	// ------------------------------------------------------
...
CATBoolean SJDSWCreateSWPointCmd::CreateSWPoint()
{
	HRESULT rc = S_OK;
...
CATBoolean SJDSWCreateSWPointCmd::DeleteNewSWPoint()
{
	_pDlg->GetPushButton(4)->SetSensitivity(CATDlgDisable);
	_pDlg->GetPushButton(3)->SetSensitivity(CATDlgDisable);
...
void SJDSWCreateSWPointCmd::CheckPreviewOKSensitivity()
{
...
//检查点焊
HRESULT SJDSWCreateSWPointCmd::CheckSWPoint(CATMathPoint iMidMathPtL, CATUnicodeString & ostrError)
{
	HRESULT rc = S_OK;
...
//四个边都要（生成十字）；
//居中：十字的短边当中；
HRESULT SJDSWCreateSWPointCmd::CheckSWPointEdgeDistance(CATUnicodeString & ostrError)
{
	HRESULT rc = S_OK;
...
//曲率检查
HRESULT SJDSWCreateSWPointCmd::CheckSWPointCurvature(CATUnicodeString & ostrError)
{
	HRESULT rc = S_OK;
	ostrError = "";
...
//检查板材厚度比
HRESULT SJDSWCreateSWPointCmd::CheckThicknessRatio(CATUnicodeString & ostrError)
{
	HRESULT rc = S_OK;
	ostrError = "";
...
//检查到其他焊点的距离
HRESULT SJDSWCreateSWPointCmd::CheckSWPointDistance(CATMathPoint iMidMathPtL, 
													CATUnicodeString & ostrError)
{
	HRESULT rc = S_OK;
	ostrError = "";
...
//Get2TPositionOfSW
HRESULT SJDSWCreateSWPointCmd::GetSWPointt2T(CATMathPoint & oMidSWPt,
...
//自焊件
HRESULT SJDSWCreateSWPointCmd::GetSelfWeldSWPoint2T(CATMathPoint & oMidSWPt, 
													CATMathPoint & oMathPt1, 
													CATMathPoint & oMathPt2, 
													CATMathPoint & oMathPt3, 
													CATMathPoint & oMathPt4)
...
//Get3TPositionOfSW
HRESULT SJDSWCreateSWPointCmd::GetSWPointt3T(CATMathPoint & oMidSWPt,
											 CATMathPoint & oMathPt1,
											 CATMathPoint & oMathPt2,
											 CATMathPoint & oMathPt3,
											 CATMathPoint & oMathPt4)
...
//自焊件
HRESULT SJDSWCreateSWPointCmd::GetSelfWeldSWPoint3T(CATMathPoint & oMidSWPt, 
													CATMathPoint & oMathPt1, 
													CATMathPoint & oMathPt2, 
													CATMathPoint & oMathPt3, 
													CATMathPoint & oMathPt4)
...
//Get4TPositionOfSW
HRESULT SJDSWCreateSWPointCmd::GetSWPointt4T(CATMathPoint & oMidSWPt,
											 CATMathPoint & oMathPt1,
											 CATMathPoint & oMathPt2,
											 CATMathPoint & oMathPt3,
											 CATMathPoint & oMathPt4)
...
//自焊件
HRESULT SJDSWCreateSWPointCmd::GetSelfWeldSWPoint4T(CATMathPoint & oMidSWPt, 
													CATMathPoint & oMathPt1, 
													CATMathPoint & oMathPt2, 
													CATMathPoint & oMathPt3, 
													CATMathPoint & oMathPt4)
...
HRESULT SJDSWCreateSWPointCmd::GetNormalDirOnSurface(CATISpecObject_var ispSpecSurface,
...
HRESULT SJDSWCreateSWPointCmd::GetInsertPointInPartWithNum(int iIntersectNum,//所取得的交点个数
...
////对点坐标根据距离远近排序（从近到远）
//HRESULT SJDSWCreateSWPointCmd::SortMathPtWithDistance(CATMathPoint iMathPt, CATLISTV(CATMathPoint) &ioMathPtList)
//													  
//{
//	HRESULT rc = S_OK;
//
...
HRESULT SJDSWCreateSWPointCmd::GetNearestPtsAll(CATMathPoint iSWMathPtG,
...
HRESULT SJDSWCreateSWPointCmd::GetSelfWeldNearestPtsAll(CATMathPoint iSWMathPtG,
...
HRESULT SJDSWCreateSWPointCmd::GetNearestPts(CATIProduct_var ispInstPrd,
...
//获得焊点到连接件贴合面的最近面、最近面上的投影点、投影点到贴合面最近边上的点，最小距离等
HRESULT SJDSWCreateSWPointCmd::GetSelfWeldNearestPts(CATIProduct_var ispInstPrd,
													 CATMathPoint imathPtG, 
...
HRESULT SJDSWCreateSWPointCmd::GetCrossLinePts(CATIProduct_var ispInstPrd,//Face所在的instPrd
...
HRESULT SJDSWCreateSWPointCmd::GetMinDistanceBetweenPointAndFace(CATFace_var ispFace,
...
//获得点和边的最小距离
HRESULT SJDSWCreateSWPointCmd::GetMinDistanceBetweenPointAndEdge(CATCurve * pCircleCurve,
																 CATMathPoint iMathPoint,
																 double &oDistance,
																 CATMathPoint & oMinPt)
{
...
HRESULT SJDSWCreateSWPointCmd::GetMinPtsOnCurveBySurSur(CATIProduct_var ispInstPrd,
														CATFace_var ipFace,
...
// CheckButtonModify ()
CATBoolean SJDSWCreateSWPointCmd::CheckButtonModify( void *data )
{
	// TODO: Define the action associated with the transition 
	// ------------------------------------------------------
...
// SelectPart ()
CATBoolean SJDSWCreateSWPointCmd::SelectPart( void *data )
{
	if (_pHSO)
		_pHSO->Empty();
	...
	{
		_pSJDSWPublicMethod->MessegeOutput("the property of definition can not be null","Error");
		RequestDelayedDestruction();
		return FALSE;
	}
...
//规定只能选择part
CATBoolean SJDSWCreateSWPointCmd::CheckSelectedPart(CATDialogAgent *iAgent,void *data)
{
...
// SelectSurface ()
CATBoolean SJDSWCreateSWPointCmd::SelectSurface( void *data )
{
	...
	AddAnalyseNotificationCB(_pSelector,
		...
		(CATCommandMethod)&SJDSWCreateSWPointCmd::Preactivate, 
		(void **)NULL);

	AddAnalyseNotificationCB(_pSelector,
		_pSelector->GetCATMove(), 
		(CATCommandMethod)&SJDSWCreateSWPointCmd::Move, 
		(void **)NULL);

	AddAnalyseNotificationCB(_pSelector,
		_pSelector->GetCATEndPreactivate(), 
		(CATCommandMethod)&SJDSWCreateSWPointCmd::EndPreactivate, 
		(void **)NULL);

	AddAnalyseNotificationCB(_pSelector,
		_pSelector->GetCATEndActivate(), 
		(CATCommandMethod)&SJDSWCreateSWPointCmd::EndActivate, 
		(void **)NULL);

	return TRUE;
}

CATBoolean SJDSWCreateSWPointCmd::Preactivate(CATCommand * iCommand,
...
CATBoolean SJDSWCreateSWPointCmd::Move(CATCommand * iCommand,
									   CATNotification * iNotification,
									   CATCommandClientData iUsefulData)
{
	//cout<<"Move"<<endl;
...
CATBoolean SJDSWCreateSWPointCmd::EndPreactivate(CATCommand * iCommand,
												 CATNotification * iNotification,
												 CATCommandClientData iUsefulData)
{
...
CATBoolean SJDSWCreateSWPointCmd::EndActivate(CATCommand * iCommand,
											  CATNotification * iNotification,
											  CATCommandClientData iUsefulData)
{
...
CATBoolean  SJDSWCreateSWPointCmd::CheckSelectedSurface(CATDialogAgent *iAgent,void *data)
{
	CATBoolean isOK = TRUE;
...
//规定选择的点必须在门的模型中，如果门的模型未选择，则退出
CATBoolean  SJDSWCreateSWPointCmd::CheckSelectedOther(CATDialogAgent *iAgent,void *data)
{
	CATBoolean isOK = TRUE;
...
CATBoolean SJDSWCreateSWPointCmd::ConnectionsFieldSelected( void *data )
{
	// TODO: Define the action associated with the transition 
	// ------------------------------------------------------
...
CATBoolean SJDSWCreateSWPointCmd::BaseSurfaceFieldSelected( void *data )
{
	// TODO: Define the action associated with the transition 
	// ------------------------------------------------------
...
CATBoolean SJDSWCreateSWPointCmd::AllCnctsSelected(void * data)
{
...
CATBoolean SJDSWCreateSWPointCmd::ActionToLeft(void * data)
{
...
CATBoolean SJDSWCreateSWPointCmd::ActionToRight(void * data)
{
...
CATBoolean SJDSWCreateSWPointCmd::ActionMiddlePB(void * data)
{
...
CATBoolean SJDSWCreateSWPointCmd::ActionDeleteNewPB(void * data)
{
...
CATBoolean SJDSWCreateSWPointCmd::ActionNextPB(void * data)
{
...
HRESULT SJDSWCreateSWPointCmd::GetCurvetureOfPointOnFace(CATGeoFactory *ipiGeomFactory,
...
// MessageOutPutYesNo()
//========================================
int  SJDSWCreateSWPointCmd::MessageOutPutYesNo(CATUnicodeString iString,CATUnicodeString iTopString)
{
	int sign=0;
