...
//--------------------------------------------------------------------------------------
TJMCreateViewWindowDlg::TJMCreateViewWindowDlg(CATDialog* iParentCommand, const CATString& iName,CATBaseUnknown_var spViewOccurrence)                              
...
void TJMCreateViewWindowDlg::Build()
{
	CreateViewer();
	...
	//AddAnalyseNotificationCB(this,GetDiaCLOSENotification(),(CATCommandMethod)&TJMCreateViewWindowDlg::Close, NULL);
	//AddAnalyseNotificationCB(this,GetWindCloseNotification(),(CATCommandMethod)&TJMCreateViewWindowDlg::Close, NULL);

}
void TJMCreateViewWindowDlg::Close(CATCommand* iSendingCommand, 
...
//--------------------------------------------------------------------------------------
void TJMCreateViewWindowDlg::CreateViewer()
{
...
//--------------------------------------------------------------------------------------                 
void TJMCreateViewWindowDlg::CreateModelRepresentation()
{
...
// VisualizeModel
//-----------------------------------------------------------------------                
void TJMCreateViewWindowDlg::VisualizeModel()
{
...
HRESULT TJMCreateViewWindowDlg::GetNavigBox(CATNavigController *&pNavigController,CATNavigBox *&pNavigBox)
{
...
HRESULT TJMCreateViewWindowDlg::CreateNavigBox( CATDialog *iDialog)
{
	HRESULT hr = E_FAIL;
...
void TJMCreateViewWindowDlg::ExpandAllNode(CATNavigController *pNavigController,CATBaseUnknown_var iRootObject,CATBaseUnknown_var iExpendObject)
{
...
void TJMCreateViewWindowDlg::ExpandCollapseNode(CATNavigController *pNavigController,CATBaseUnknown_var iObject)
{
...
void TJMCreateViewWindowDlg::DeleteWindow()
{
	CATFrmEditor * pEditor = CATFrmEditor::GetCurrentEditor();
	CATPSO * pPSO = pEditor->GetPSO() ;   
	CATHSO * pHSO = pEditor->GetHSO() ; 
