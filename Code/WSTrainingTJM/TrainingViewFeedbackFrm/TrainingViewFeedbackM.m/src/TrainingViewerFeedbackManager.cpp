...
//===================================================================
//
// TrainingViewerFeedbackManager.cpp
...
extern TrainingViewerFeedbackManager * _ViewerFeedbackManager = NULL ;
 
CATImplementClass( TrainingViewerFeedbackManager,
                   Implementation, 
                   CATBaseUnknown,
                   CATNull );
 
//-----------------------------------------------------------------------------
// TrainingViewerFeedbackManager : constructor
//-----------------------------------------------------------------------------
...
_piUnknown(NULL)
{
	//cout <<" TrainingViewerFeedbackManager::TrainingViewerFeedbackManager" << endl;
}

//-----------------------------------------------------------------------------
// TrainingViewerFeedbackManager : destructor
//-----------------------------------------------------------------------------
TrainingViewerFeedbackManager::~TrainingViewerFeedbackManager()
{
	//cout <<" TrainingViewerFeedbackManager::~TrainingViewerFeedbackManager" << endl;
...
//-----------------------------------------------------------------------------
// TrainingViewerFeedbackManager : copy constructor
//-----------------------------------------------------------------------------
TrainingViewerFeedbackManager::TrainingViewerFeedbackManager(TrainingViewerFeedbackManager& original):
   CATBaseUnknown(original)
{
}
 
//-----------------------------------------------------------------------------
// TrainingViewerFeedbackManager : equal operator
//-----------------------------------------------------------------------------
TrainingViewerFeedbackManager& TrainingViewerFeedbackManager::operator=(TrainingViewerFeedbackManager& original)
{
   CATBaseUnknown::operator=(original);
   return *this;
}
 
void TrainingViewerFeedbackManager::GetManager(TrainingViewerFeedbackManager ** opManager)
{
	if ( NULL != opManager )
	{      
		*opManager = NULL ;
		...
		//}else
		//{
			*opManager = new TrainingViewerFeedbackManager() ;
...
//-------------------------------------------------------------------------
void TrainingViewerFeedbackManager::SetViewerFeedbackOn()
{
	//cout << " TrainingViewerFeedbackManager::SetViewerFeedbackOn" << endl;
		...
		if ( NULL != _pCurrentViewer )
		{
			...
			if (0 == _ViewerFeedbackCB)
			{
				...
				_ViewerFeedbackCB = ::AddCallback(this,
					...
					(CATSubscriberMethod) & TrainingViewerFeedbackManager::ViewerFeedbackCB, NULL);
			}
		}
	} 
	...
	if (0 == _WindowActivatedCB)
	{
		_WindowActivatedCB = ::AddCallback(this,
			...
			(CATSubscriberMethod) & TrainingViewerFeedbackManager::WindowActivatedCB, NULL);
	}
	if (0 == _WindowDeactivatedCB)
	{
		_WindowDeactivatedCB = ::AddCallback(this,
			...
			(CATSubscriberMethod) & TrainingViewerFeedbackManager::WindowDeactivatedCB, NULL);
	}
	if (0 == _WindowDeletedCB)
	{
...
//-------------------------------------------------------------------------
void TrainingViewerFeedbackManager::SetViewerFeedbackOff()
{
	//cout << " TrainingViewerFeedbackManager::SetViewerFeedbackOff" << endl;
...
void TrainingViewerFeedbackManager::ViewerFeedbackCB( CATCallbackEvent   event,
												   void             * client,
...
void TrainingViewerFeedbackManager::PathElementString(CATPathElement * ipPath, 
...
void TrainingViewerFeedbackManager::ChangeBagPosition(float Xpos, float Ypos)
{
...
void TrainingViewerFeedbackManager::WindowActivatedCB( CATCallbackEvent   event,
													void             * client,
													CATNotification  * notification,
													CATSubscriberData  data,
													CATCallback        callback)
{
	//cout << " TrainingViewerFeedbackManager::WindowActivatedCB"  << endl;
...
void TrainingViewerFeedbackManager::WindowDeactivatedCB( CATCallbackEvent   event,
													  void             * client,
													  CATNotification  * notification,
													  CATSubscriberData  data,
													  CATCallback        callback)
{
	//cout << " TrainingViewerFeedbackManager::WindowDeactivatedCB"  << endl;
...
//输出：CATMathPoint
//返回：CATMathPoint
CATMathPoint TrainingViewerFeedbackManager::GetScreenPickedPoint()
{
	return _mathPickPt;
}
...
//输出：CATMathPoint2D
//返回：CATMathPoint2D
CATMathPoint2D TrainingViewerFeedbackManager::GetScreen2DPoint()
{
	return _math2DPt;
}
...
//输出：CATBaseUnknown
//返回：CATBaseUnknown
CATBaseUnknown *TrainingViewerFeedbackManager::GetPickedObject()
{
	return _piUnknown;
}