...
#ifndef YFAirventXMLClass_H
#define YFAirventXMLClass_H

#include "YFAirventXMLM.h"

#include <iostream>
#include "tinyxml.h"

class ExportedByYFAirventXMLM YFAirventXMLClass
{
public:

	YFAirventXMLClass ();

	virtual ~YFAirventXMLClass ();

private:

	YFAirventXMLClass (YFAirventXMLClass &);

	YFAirventXMLClass& operator=(YFAirventXMLClass&);
